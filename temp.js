...
, function(t, n) {
    t.exports = {
        ...
        It: function(t) {
            ...
            var n, i = [];
            for (n in t)
                this.xt.call(t, n) && i.push(n + "=" + encodeURIComponent(t[n]));
            return i.join("&")
        },
        kt: function(t) {
            for (var n in t)
    ...
    t.exports = {
        ...
        jt: function(t, n) {
            ...
            if (document.getElementsByClassName)
                ...
                for (var i = [], e = document.getElementsByTagName(n), r = 0, o = e.length; r < o; r++) {
                    var a = e[r]
        ...
        Wt: function(t) {
            var n;
            return t.Vt || (n = t.containerId,
            t.Vt = this.g(n) || this.zt(n, "div", function(t) {
                var n, i = e.__slotMap;
                for (n in i)
                    if (i.hasOwnProperty(n) && i[n] && i[n].Vt === t)
                        return !1;
                return !0
            })),
            t.Vt
        ...
        Qt: function(t, n, u) {
            ...
            r.Ht(this, function() {
                var t = !1
                  , n = (this.domReadyMonitorRunTimes++,
                !1);
                try {
                    u.frameElement && (n = !0)
                } catch (o) {
                ...
                else if ("complete" === s.readyState || this.domContentLoaded)
                    t = !0;
                else if (3e5 < this.domReadyMonitorRunTimes)
                    return void (this.domReadyMonitorId && (u.clearInterval(this.domReadyMonitorId),
                    this.domReadyMonitorId = null));
                if (t)
                    try {
                        if (this.readyFuncArray && this.readyFuncArray.length)
                            for (var i = 0, e = this.readyFuncArray.length; i < e; i++) {
                                var r = this.readyFuncArray[i];
                                r && r.func && !r.done && (r.delay ? (r.done = !0,
                                u.setTimeout(r.func, r.delay)) : (r.done = !0,
                                r.func()))
                            }
                    } catch (a) {} finally {
                        this.domReadyMonitorId && (u.clearInterval(this.domReadyMonitorId),
                        this.domReadyMonitorId = null)
                    }
            }))
            ...
            this.domReadyMonitorId || (this.domReadyMonitorId = u.setInterval(i, 50),
            s.addEventListener ? (s.addEventListener("DOMContentLoaded", t, !1),
            u.addEventListener("load", t, !1)) : s.attachEvent && u.attachEvent("onload", t, !1))
        },
        Zt: function(t, n, i) {
        ...
        tn: function(t, n) {
            1 === arguments.length && r.Ut(arguments[0]) && (n = arguments[0],
            t = undefined),
            n = n || 10;
            for (var i = window, e = 0; e++ < n && this.Xt(i) && !this.Yt(i) && (!t || !t(i)); )
                i = i.parent;
            return i
        },
        nn: function(t) {
        ...
        on: function(t, i, n, e) {
            try {
                ...
                if (!r.attachEvent || r.attachEvent.toString && r.attachEvent.toString().indexOf("[native code") < 0 || c.opera ? (this.Zt(r, "error", n),
                this.Zt(r, "load", i)) : this.Zt(t, "readystatechange", function(t) {
        ...
        un: function(t, n) {
            ...
            return t.removeAttribute && (t.removeAttribute("id"),
...
, function(t, n, i) {
    ...
    p.__slotMap)
      , w = p.counter || {}
      , g = (w.slotTotalCount = w.slotTotalCount || 1,
    ...
    t.exports = {
        ...
        An: function(t) {
            for (var n in m)
                if (m.hasOwnProperty(n) && -1 < n.indexOf(t))
                    return m[n];
            return {}
        },
        In: function(t) {
        ...
        processSlot: function(t) {
            var n = t.response.rtb_deliv = t.response.rtb_deliv || {}
              ...
              , e = (e.demand_id = parseInt(e.demand_id, 10),
        ...
        On: function() {
            var t, n, i = m;
            for (t in i)
                t && i[t] && i.hasOwnProperty(t) && ((n = i[t]).status >= c.N || (this.Pn(n),
                this.Mn(n),
                this.Nn(n)))
        },
        Nn: function(t) {
        ...
        Bn: function(t, n) {
            "object" != typeof window.__baidu_dup_jobruner && 1 !== n.proxy && (n.proxy = 1,
            this.Mn(n),
            "block" !== window.__baidu_dup_jobruner) && (window.__baidu_dup_jobruner = "block",
            r.Un(c.ht, n.proxy + "|" + (new Date).getTime()))
        },
        Mn: function(t) {
            !p.Rn && window.postMessage && (p.Rn = !0,
            h.Zt(window, "message", u.Ht(this, this.Ln))),
            t.validContent = _.Fn(h.Wt(t), 3);
            var n, i = t.isUnion || t.isAsync, e = (t.proxy = t.proxy || this.Hn(t),
            t.paramObj = t.paramObj || o.jn(t),
            t.paramObj.dtm = c.D,
            t.domainInfo.mixOffset), e = o.zn(t.paramObj, t.proxy, e), r = c.S + e;
            1 === t.proxy && t.domainInfo.mixOffset && (n = t.domainInfo.pos || t.domainInfo.dup,
            r = c.v + "//" + n + "/" + a.ln(5, 10) + "?" + e),
            t.paramObj.dtm = c.T,
            (n = this.Wn(t)) ? window[c.A](n) : (this.Vn(r, i),
        ...
        Ln: function(t) {
            ...
            i && i.tuid && (i && (this.Kn(t),
            i.tuid) && p.__iframesStatus[i.tuid] && (p.__iframesStatus[i.tuid].status = 1),
            n = this.An(i.tuid),
            i.placement && i.placement.update && i.queryid ? this.Xn(i, n) : 1 === i.type ? this.Gn(t, i, n) : 2 === i.type && this.Yn(t, i, n))
        },
        Kn: function(t) {
            ...
            t === c.C ? (g = !0,
            r.Un("___ds_storage__search_isblock", "0|" + (new Date).getTime())) : g || r.Un("___ds_storage__search_isblock", "1|" + (new Date).getTime())
        },
        Qn: function(t) {
            var n, i, e;
            500 <= 1e4 * Math.random() || (t = t.tuid,
            n = (t = this.An(t)).paramObj || {},
            i = 0,
            t.isDsFlow && (i = t.proxy ? 2 : 1),
            e = Number(n.pcs && n.pcs.split("x")[1]) - Number(n.ps && n.ps.split("x")[0]),
            s.Zn("tc", {
                di: n.di,
                t1: t.t1,
        ...
        Xn: function(t, n) {
            ...
            !r && t.wnid && t.dspid) {
                var a = [];
                if ("" + t.dspid == "9" && t["extends"] && t["extends"].oneSkipStr && "[object Array]" === Object.prototype.toString.call(t["extends"].oneSkipStr))
                    try {
                        for (var u = 0; u < t["extends"].oneSkipStr.length; u++)
        ...
        ei: function(t) {
            var n = t.placement.update
              , i = r.hn(t.tuid);
            i && (i = u.Et(i),
            r.oi()) && window.JSON && window.JSON.stringify && i && i.placement && i.placement.update && i.placement.update !== n && (t.adExpire = (new Date).getTime(),
        ...
        ai: function(t) {
            try {
                var n = t.response
                  , i = t.id;
                i && !t.isPdbAd && t.isUnion && !t.isAutoAd && window.JSON && window.JSON.stringify && r.oi() && !r.hn(i) && (n.adExpire = (new Date).getTime(),
                r.Un(i, JSON.stringify(n)))
            } catch (e) {}
        },
        Pn: function(t) {
            h.Wt(t) || (t.isAsync ? "union" === t.productLine && (t.containerId = "cpro_" + t.slotId) : (document.write('<div id="' + t.containerId + '"></div>'),
        ...
        ui: function(t) {
            try {
                ...
                if (i) {
                    ...
                    if (r)
                        return (e = document.createElement("div")).id = t.containerId,
                        r.insertBefore(e, i),
                        !0
                }
            } catch (o) {}
        ...
        Vn: function(t, n) {
            var i;
            n ? (n = document.createElement("script")) && (n.type = "text/javascript",
            n["async"] = !0,
            n.src = t,
            (i = document.getElementsByTagName("script")[0]) && i.parentNode ? i.parentNode.insertBefore(n, i) : document.write('<script charset="utf-8" src="' + t + '"><\/script>')) : document.write('<script charset="utf-8" src="' + t + '"><\/script>')
        },
        si: function(t) {
            var n = t.response
              , i = n.pdb_deliv
        ...
        ci: function(t) {
            var n, i, e = t.response.placement, r = t.response["extends"] || {}, o = h.Wt(t) || {}, e = e.container, a = t.styleOpenApi, u = e.width, s = e.height, c = a.cpro_w || a.rsi0 || 0, f = a.cpro_h || a.rsi1 || 0, e = e.sizeType, d = (5 !== e && !t.isUnion && r && r.hasOwnProperty("sspw") && r.hasOwnProperty("ssph") && (n = parseInt(r.sspw || 0, 10),
            ...
            u = c || l.fi(),
            s = f || s),
            ("-1" === t.pcwd || t.ftpc || t.styleOpenApi.cpro_ftpc) && (e = "-1" === t.pcwd && "-1" === t.pchd ? 8 : 5),
            a.sizeType && (e = a.sizeType && parseInt(a.sizeType, 10) || e,
        ...
        Hn: function(t) {
            var n = 0;
            return t.isAnti && (window[c.et] ? n = "block" === window[c.et] ? 1 : 0 : 0 !== (t = r.pi("isblock").value) && 1 !== t || (n = t,
...
, function(t, n) {
    var i = "___delivery___global___counter___"
      , e = (window._SF_ && window._SF_._global_ && window._SF_._global_._ssp && !window.___baidu_union && ((e = window._SF_._global_._ssp).DUP_4_SF = !0,
    e.destroy = function() {
        try {
            window.top[i] = {}
        } catch (t) {
    ...
    var r = "yptqys.tianqistatic.com";
    e.domainInfo,
    e.domainInfo = {
        dup: r,
        pos: "so.tianqistatic.com"
    },
    t.exports = e
}
, function(t, n, i) {
    ...
    t.exports = {
        ...
        mi: function(t) {
            var n = (t = s.Bt(t) ? t : {}).url || "https://eclick.baidu.com/se.jpg"
              , i = t.data || {}
              , t = t.option || "now"
              , i = s.It(i);
            switch (n += (0 <= n.indexOf("?") ? "&" : "?") + i + (i ? "&" : "") + "ver=0620&rdm=" + +new Date,
            t) {
            case "now":
                this.vi(n);
                break;
            ...
            default:
                r.wi(u, n, !0),
                e.Zt(window, "unload", s.Ht(this, function() {
        ...
        bi: function(t, n, i) {
            ...
            if (i)
                for (var r in i)
                    i.hasOwnProperty(r) && (i[r] || 0 === i[r]) && (e += "&" + r + "=" + i[r]);
            this.mi({
                url: e,
                option: "now"
            })
        ...
        yi: function(t) {
            var n, i;
            return t ? (n = [],
            i = (i = "" + (new Date).getTime()).substr(0, i.length - 3),
            t.wnid && t.dspid && (n.push("wnid=" + t.wnid),
            ...
            n.push("uid=" + t.uid),
            n.push("type=show"),
            (c = t.cipherWnPath ? "https://" + t.cipherWnPath + "/" + o.ln(4, 4) + "?c=" : c) + a.xi(n.join("\0"))) : ""
        },
        Ai: function(t) {
            try {
                if (!t)
                    return [];
                var n = [];
                if ("" + t.dspid == "9" && s.Mt(t.oneSkipArr) && 0 < t.oneSkipArr.length)
                    for (var i = 0; i < t.oneSkipArr.length; i++) {
                        ...
                        o = Math.random().toString(16).slice(2, 8) + Math.random(),
                        n.push("https://ada.baidu.com/udpl/exp?data=" + r + "&rand=" + o))
                    }
                return n
            } catch (u) {
                return []
...
, function(t, n, i) {
    ...
    i = {
        Ii: function() {
            ...
            try {
                /(\d+\.\d)/.test(a.At(window, "external.max_version")) && (this.maxthon = +n.$1)
            } catch (o) {}
            ...
            for (var i = ["Android", "iPad", "iPod", "iPhone", "iOS", "Linux", "Macintosh", "Windows"], e = "", r = 0; r < i.length; r++)
                if (e = i[r],
                t.match(new RegExp(e,"i"))) {
        ...
        ki: function() {
            ...
            try {
                ...
                if (45 <= this.chrome || i)
                    return 0;
                if (0 === (t = c.plugins && c.mimeTypes.length && (n = c.plugins["Shockwave Flash"]) && n.description ? n.description.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s)+r/, ".") + ".0" : t) && (s.ActiveXObject || s.hasOwnProperty("ActiveXObject")))
                    for (var e = 30; 2 <= e; e--)
                        try {
                            var r = new ActiveXObject("ShockwaveFlash.ShockwaveFlash." + e);
                            if (r) {
                                var o = r.GetVariable("$version");
                                if (0 < (t = o.replace(/WIN/g, "").replace(/,/g, ".")))
                                    break
                            }
                        } catch (a) {}
                t = parseInt(t, 10),
        ...
        Si: function(t) {
            return !(!t || !/(www\.baidu\.com)|(m\.baidu\.com)/.test(t)) || !(!(t = e.hn(r.bt)) || 18e5 <= (new Date).getTime() - Number(t) && (e.Ci(r.bt),
            1))
        },
        Ti: function(t) {
            ...
            if (t) {
                var n = (new Date).getTime()
                  , t = t.split("|");
                if (2 <= t.length && n - Number(t[1]) < 18e5)
                    return t[0];
                e.Ci(r.yt)
            }
            return ""
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        Oi: function(t) {
            ...
            return t !== a.nn(t) && (i = (n = a.qt(t)).body,
            n = n.documentElement,
            i && t.getBoundingClientRect) && (t = t.getBoundingClientRect(),
            e.left = Math.floor(t.left) + Math.max(n.scrollLeft, i.scrollLeft),
            e.top = Math.floor(t.top) + Math.max(n.scrollTop, i.scrollTop),
            e.left -= n.clientLeft,
            e.top -= n.clientTop,
        ...
        Pi: function(t, n) {
            if (t) {
                var i, e = "", e = -1 < n.indexOf("-") ? n.replace(/[-][^-]{1}/g, function(t) {
                ...
                if (r && r.getComputedStyle && r.CSSStyleDeclaration && r.CSSStyleDeclaration.prototype.getPropertyValue) {
                    if (i = r.getComputedStyle(t, null))
                        return i.getPropertyValue(n) || i.getPropertyValue(e)
        ...
        Bi: function(t) {
            ...
            try {
                for (var e = 0; e++ < 10 && a.Xt(n) && !a.Yt(n); )
                    i *= (n.frameElement ? this.Ni(n.frameElement) : 100) / 100,
                    n = n.parent
            } catch (r) {}
            return i
        },
        ...
        Vi: function(t) {
            for (; t && t.tagName; ) {
                if ("hidden" === this.Pi(t, "visibility"))
                    return !1;
                t = t.parentNode
            }
            return !0
        ...
        qi: function(t) {
            try {
                ...
                for (var e = 0; n; ) {
                    i = this.Pi(t, "visibility");
                    if ("hidden" !== this.Pi(n, "visibility") && "hidden" === i)
                        return t;
                    if (n = (t = n).parentNode,
                    10 <= e)
                        return;
        ...
        cn: function(t) {
            for (var n = null, i = !1, e = !1; t && t.tagName; ) {
                if (i = "hidden" === this.Pi(t, "visibility"),
        ...
        hi: function(t) {
            var n, i;
            return t && (n = parseInt(this.Pi(t, "paddingLeft"), 10) || 0,
            i = parseInt(this.Pi(t, "paddingRight"), 10) || 0,
            0 < (t = t.clientWidth - n - i)) ? t : window.screen.width
        },
        li: function(t) {
            var n, i;
            return t && (n = parseInt(this.Pi(t, "paddingTop"), 10) || 0,
            i = parseInt(this.Pi(t, "paddingBottom"), 10) || 0,
            0 < (t = t.clientHeight - n - i)) ? t : 0
        },
        Ki: function() {
            var t = !0;
...
, function(t, n, i) {
    var e, r, o, a = i(4), u = i(1), s = {};
    if (!a.__onlyExps)
        for (o in a.__onlyExps = {},
        s)
            s.hasOwnProperty(o) && s[o] && (r = s[o]).onlyExp && (e = r.expId,
            r = r.baseId,
            e && (a.__onlyExps[e] = !0),
            r) && (a.__onlyExps[r] = !0);
    t.exports = {
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        se: function(t, n) {
            return !(!t || !n || ((s = this.re("pageConfig") || {})[t] = n,
    ...
    t.exports = {
        ...
        gi: function(t, n, i) {
            if (r) {
                n = i ? encodeURIComponent(n) : n;
                i = this.hn(t) || "";
                if (i = i.replace(new RegExp(n + "\\|?","g"), "").replace(/\|$/, ""))
                    try {
                        this.Un(t, i)
                    } catch (e) {}
                else
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        getFrameHTML: function(t) {
            var n, i;
            return t.isPdbAd ? e.he(t) : (n = this.de(t),
            i = this.le(t),
            t && (t.t3 = (new Date).getTime()),
            this.pe(i, t.isDsFlow, n))
        },
        le: function(t) {
            var n, i = t.containerInfo, e = t.width || i.width, r = t.height || i.height, o = t.isDsFlow || t.isAnti ? c.ve(t) : c.getPmpRequestUrl(t), a = "";
            return t.isNeedCacheRequest ? (n = t.response.queryid,
            s._e(n, t),
            d.ae("adsbybaidu_callback", f.Ht(s, s.me)),
            a = 'onload="' + u.h + "(1, '" + n + "', this);\"") : (t.styleOpenApi && t.styleOpenApi.floatingState && "show" !== t.styleOpenApi.floatingState || 2 === i.location) && (n = t.styleOpenApi && t.styleOpenApi.floatingState ? t.styleOpenApi.floatingState : "upSlideShow",
            a = 'onload="' + u.h + "(2, '" + i.location + "', '" + n + "', this);\""),
            {
...
, function(t, n, i) {
    ...
    t.exports = {
        Zt: function(t, n, i) {
            var e;
            return t && (t.addEventListener ? t.addEventListener(n, i, !1) : t.attachEvent ? t.attachEvent("on" + n, i) : (e = t["on" + n],
            t["on" + n] = function() {
        ...
        ii: function(t) {
            var n, i = o[t];
            r.Nt(i) && (n = Array.prototype.slice.call(arguments, 1),
            i.apply(window, n))
        }
    }
}
    ...
    t.exports = {
        ...
        xe: function(t, n) {
            ...
            for (var i = t.childNodes, e = [], r = 0; i[r]; r++)
                !this.be(i[r], "script") || i[r].type && "text/javascript" !== i[r].type.toLowerCase() || e.push(i[r]);
            e.reverse();
        ...
        Ae: function(t, n) {
            ...
            if (t && !s.En(t, u.R)) {
                var i = t.response.pdb_deliv.deliv_des._html
                  , e = this.Ie();
                if (this.ke() && n.getAttribute("src", 2) !== e)
                    n.src = e;
                    ...
                    try {
                        s.Dn(t.id, u.R);
                        var r = c.Se(i, t)
                          , o = (r.indexOf("<body>") < 0 && (r = "<!DOCTYPE html><body>" + r),
        ...
        ke: function() {
            ...
            return !!document.body && (n.src = "about:blank",
        ...
        renderRichMaterial: function(t) {
            var n, i, e = t.response, e = e && e.pdb_deliv && e.pdb_deliv.deliv_des, e = e && e._html, r = t.isNeedCacheRequest;
            return !(!e || "rich" !== e.type || r) && (r = o.Wt(t),
            e = e.content,
            i = t.isAsync,
            n = t.productLine,
            i ? !r || "clb" !== n && "dup" !== n ? this.xe(r, e) : (i = this.he(t),
            r.innerHTML = i,
            !0) : (document.write(e),
            s.Dn(t.id, u.R),
            !0))
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        jn: function(t) {
            for (var n = this.Ee(t), i = {}, e = 0, r = n.length; e < r; e++) {
                var o = n[e];
                i[o.key] = o.value
            }
            return i
        ...
        Oe: function(t) {
            ...
            u.setSlotInfo(t),
            v.De(h.tn());
            for (var e = 0, r = (n = (n = n.concat(this.Te(v))).concat(this.Te(u))).length; e < r; e++) {
                var o = n[e];
                i[o.key] = o.value
            }
            return i
        ...
        zn: function(t, n, i, e) {
            var r, o, a, u = [];
            for (r in t)
                !r || !t[r] && 0 !== t[r] || !t.hasOwnProperty(r) || e && e[r] || (o = t[r],
                u.push(r + "=" + o));
            return n && (u = d.Pe(u)),
            window && window.location && window.location.ancestorOrigins && window.location.ancestorOrigins.length && (a = window.location.ancestorOrigins,
        ...
        getPmpRequestUrl: function(t) {
            ...
            ["conwid=" + t.width, "conhei=" + t.height])
              ...
              , o = i.order_deliv
              , a = i.rtb_deliv
              , i = (i.media_protect && "0" !== i.media_protect && e.push("mpdi=" + i.media_protect),
        ...
        ve: function(t) {
            ...
            r.di = !0,
            this.Ne(n, o, r, t),
            n.ltu && (o.push("ltu=" + n.ltu),
            r.ltu = !0),
            t.isUnion ? o.push("dc=3") : o.push("dc=2"),
            1 === t.proxy)
                for (var a = ["utdi", "drs", "cfv", "cpl", "chi", "cce", "tlm", "psr", "ccd", "cja", "cmi", "col", "cdo", "tcn", "ltr"], u = 0; u < a.length; u++)
                    r[a[u]] = !0;
        ...
        Be: function(t, n, i, e, r, o) {
            var i = n + i + r.join("&") + "&"
              ...
              , u = ""
              , s = !1
              , n = (1 === t.proxy && a && a.pos && (i = n + "//" + a.pos + "/",
            f.ie ? i = i + "s?" + r.join("&") + "&" : (u = c.kn(a.pos),
            i = i + d.ln(5, 10) + "?" + c.Me(u, r, f.isAndroid) + "&",
            s = !0)),
        ...
        Re: function(t, n) {
            ...
            if (i)
                for (var e = 0; e < i.length; e++)
                    if (i[e].key === n)
                        return l.Ht(_[t], i[e].value)()
        },
        Le: function(t) {
            var n, i;
            if ("wap" === t.flowType)
                return n = (t = t.paramObj).dis,
    ...
    t.exports = {
        ...
        ze: function(t, n) {
            var i = t.paramObj
              ...
              , f = (2 === f.length && (c = Number(f[1]) <= r ? 0 : c),
            "" + t.slotId)
              , t = {
                uid: t.id,
                slotId: f,
              ...
              , f = (1 === a && s && s.wn && (t.cipherWnPath = s.wn),
        ...
        We: function(t, n) {
            if (Object.defineProperty && "function" == typeof Object.defineProperty)
                try {
        ...
        Ze: function(t) {
            ...
            if (w)
                try {
                    ...
                    a = g.innerWidth || document.documentElement.clientWidth,
                    u = this.Mi(n),
                    s = m.Hi(n),
                    c = m.zi(n),
                    ...
                    p = s * c,
                    f < d && h < l && (v = (d - f) * (l - h),
                    e = t.mode ? v > t.mode * p : 15 < d - f)) : e = i = !1
                } catch (_) {}
            return {
                isInView: i,
                isAdView: e,
        ...
        tr: function(t) {
            r.ie ? (e.Zt(t, "focusin", a.Ht(this, this.er)),
            e.Zt(t, "focusout", a.Ht(this, this.rr))) : (e.Zt(t, "focus", a.Ht(this, this.er)),
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        sr: function(t) {
            try {
                var n = e.xn(t.tuid);
                !n || n.containerId && !l.Wt(n) || (n.t0 && (n.t1 = (new Date).getTime() - n.t0),
                n.response = t,
                e.Dn(n.id, r.B),
                e.processSlot(n),
                e.ai(n),
        ...
        pr: function(t, n) {
            var i;
            return n && t.paramObj && (i = t.paramObj.exps,
        ...
        lr: function(t) {
            var n = u.vr(t)
              , i = w._r(t, n);
            n && i && (O.setExpNumber(t, n),
            P.mr(t),
            (i = M[n] || this.wr(n)) ? this.gr(n, t, i) : this.br(n, t))
        },
        br: function(t, n) {
            var i = t;
        ...
        wr: function(t) {
            var n = v.painter;
            if (n)
                return "mobile" === (t = t.split("."))[0] ? n.mobile && n.mobile[t[1]] : n[t[0]]
        },
        gr: function(t, n, i) {
            i && (i.render(n),
            this.Ir(n),
        ...
        kr: function(t) {
            var n = l.Wt(t);
            -1 < (t.paramObj.dis ? t.paramObj.ltu : window.location.href).indexOf(r.nt) && t.isAutoAd && n && g.Wi(n, t)
        }
    }
}
, function(t, n) {
    t.exports = {
        mi: function(t) {
            var n, i, t = t.response.pdb_deliv.deliv_des, t = t && t._html, t = t && t.monitorUrl;
            t && (n = new Image,
            i = "log" + +new Date,
            window[i] = n,
            "http" === t.substr(0, 4).toLowerCase() ? "https://" === (t = "http://" === t.substr(0, 7).toLowerCase() ? t.replace("http://", "//") : t).substr(0, 8).toLowerCase() && (t = t.replace("https://", "//")) : t = "//" + t,
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        Nr: function(t) {
            ...
            if (f.Bt(i))
                for (var e in i)
                    f.xt.call(i, e) && (e = e + "=" + i[e].join(","),
                    n[n.length] = e);
            d.ne(this.Dr, undefined),
            n.sort(function(t, n) {
                return t.length - n.length
            });
            for (var r = "", o = n.length, a = 0; a < o && !(r.length + n[a].length >= t); a++)
                r += (a ? "&" : "") + n[a];
            return r
        }
    }
...
, function(t, n) {
    t.exports = {
        ...
        Rr: function(t, n) {
            for (var i in n)
                i && n.hasOwnProperty(i) && this.Br[i] && (t[this.Br[i]] = n[i])
        },
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        Me: function(t, n, i) {
            for (var e = this.Lr(t), r = this.Fr(t), o = {}, a = 0; a < n.length; a++) {
                n[a] = n[a].replace(/\./g, "%_"),
                n[a] = n[a].replace(/%/g, ".");
                var u = n[a].split("=");
                o[u[0]] = u[1]
...
, function(t, n, i) {
    ...
    t.exports = {
        Jn: function(t) {
            try {
                var n;
                !r.antiScript && this.Wr(t) && (r.antiScript = document.createElement("script"),
                r.antiScript.type = "text/javascript",
                r.antiScript["async"] = !0,
                r.antiScript.src = "https://cpro.baidustatic.com/cpro/ui/ab.min.js",
                (n = document.getElementsByTagName("script")[0]) && n.parentNode && n.parentNode.insertBefore(r.antiScript, n),
                o.on(r.antiScript, function() {
                    window.BAIDU_SSP_sendAntiLog && window.BAIDU_SSP_sendAntiLog()
                }),
                s.ae("__abbaidu_2028_cb", u.Ht(this, function(t) {
        ...
        dr: function(t) {
            if (this.Wr(t)) {
                ...
                if ("asd" !== t.productLine && "asdv" !== t.productLine && "asdr" !== t.productLine && 700 === n.value && 10 < r)
                    return null;
                switch (n.value) {
                case 300:
                    i = "119016";
            ...
            if ("success" !== n) {
                ...
                if (n) {
                    var i = n.response
                      ...
                      , o = i.order_deliv
                      , a = e.deliv_des._html || {};
                    if (0 === parseInt(e.deliv_id, 10) && (0 !== parseInt(o.deliv_id, 10) || 0 !== parseInt(r.deliv_id, 10)) && 7 === i.placement.complement_type)
                        return this.Gr(n);
                    "rich" === a.type ? (e = c.Wt(n),
                    f.xe(e, a.content)) : (o = d[t.dpv],
                    u.Tn(n, s.R),
                    o.outerHTML = f.he(n))
                }
            }
    ...
    t.exports = {
        xi: function(t) {
            try {
                ...
                for (var n, i, e = String(t), r = 0, o = f, a = ""; e.charAt(0 | r) || (o = "=",
                r % 1); a += o.charAt(63 & n >> 8 - r % 1 * 8)) {
                    if (255 < (i = e.charCodeAt(r += .75)))
        ...
        Yr: function(t) {
            try {
                ...
                for (var i, e, r = 0, o = 0, a = ""; e = n.charAt(o++); ~e && (i = r % 4 ? 64 * i + e : e,
                r++ % 4) && (a += String.fromCharCode(255 & i >> (-2 * r & 6))))
                    e = f.indexOf(e);
                return a
            } catch (u) {
                s.an(c.Z, u, {
...
, function(t, n, i) {
    ...
    t.exports = {
        paramsList: [{
            ...
            encode: !0,
            value: function() {
                var t, n, i = [], e = this.Ur.styleOpenApi;
                for (t in "-1" === this.Ur.pcwd && (e.cpro_ftpc = "true"),
                e)
                    t && "undefined" != typeof e[t] && e.hasOwnProperty(t) && "width" !== (n = t) && "height" !== t && "sizeType" !== t && "apType" !== t && "floatingState" !== t && ("cpro_w" === t && (n = "rsi0"),
                    i.push((n = "cpro_h" === t ? "rsi1" : n) + "=" + encodeURIComponent(e[t])));
                return i.join("&")
            }
        }, {
            key: "enu",
            ...
            value: function() {
                ...
                if (t && 0 <= t.indexOf(u.rt)) {
                    for (var n, i = t.split(","), e = 0; e < i.length; e++)
                        (n = parseInt(i[e], 10)) !== u.rt && n !== u.st && n !== u.ot && n !== u.ut || 1 !== this.Ur.proxy || (i[e] = "" + (n += 1));
                    t = i.join(",")
                }
...
, function(n, i, _) {
    ...
    !function() {
        ...
        function a(t, n) {
            t[n >> 5] |= 128 << n % 32,
            t[14 + (n + 64 >>> 9 << 4)] = n;
            for (var i, e, r, o, a = 1732584193, u = -271733879, s = -1732584194, c = 271733878, f = 0; f < t.length; f += 16)
                a = h(i = a, e = u, r = s, o = c, t[f], 7, -680876936),
        ...
        function e(t) {
            for (var n, i = "0123456789abcdef", e = "", r = 0; r < t.length; r += 1)
                n = t.charCodeAt(r),
        ...
        function o(t, n) {
            var i, t = f(t), n = f(n), e = c(t), r = [], o = [];
            for (r[15] = o[15] = undefined,
...
, function(t, n, i) {
    ...
    t.exports = {
        paramsList: [{
            ...
            value: function() {
                var t, n, i, e;
                return "union" !== this.Ur.productLine && (t = d.referrer) ? (n = (n = (n = t.replace(/^https?:\/\//, "")).split("/")[0]).split(":")[0],
                n = u.zr(n),
                i = u.zr(),
                (e = s.$r(r.I)) && i === n ? e : i !== n ? (s.no(r.I, t, {
                    domain: i
                }),
                t) : "") : ""
            }
        ...
        paramsList: [{
            ...
            value: function() {
                ...
                if (t && 0 <= t.indexOf(o.rt)) {
                    for (var n, i = t.split(","), e = 0; e < i.length; e++)
                        (n = parseInt(i[e], 10)) !== o.rt && n !== o.st && n !== o.ot && n !== o.ut || 1 !== this.Ur.proxy || (i[e] = "" + (n += 1));
                    t = i.join(",")
                }
            ...
            key: "dis",
            value: function() {
                var t, n = 0, i = (a.Xt(h) && (n += 1),
                a.Yt(h, h.top) && (n += 2),
                u.Ei()), e = u.Di();
                (i < 40 || e < 10) && (n += 4);
                try {
                    !0 & n && (t = a.tn()).document.referrer && t.top === t.parent && (n += 8)
                } catch (r) {
                    s.an(o.Z, r, {
                        pos: "disParam"
                    })
    ...
    t.exports = {
        ...
        ro: function(e, r) {
            var o = this
              , t = "0px 0px 0px 0px"
              , n = [0, .26, 1];
            return r.mode || (t = "-15px 0px -15px 0px",
            n = [0, 1]),
            ...
            try {
                ...
                if (t.intersectionRatio > n.mode) {
                    var o = t.target
                      , a = h.Bi(o)
                      , u = h.Ji(o);
                    if (50 <= a && u && (r = i.currAdViewStatus = !0,
                    i.haveShown || (i.haveShown = !0,
                    this.qe(n))),
                    !u && 50 <= a && this.eo)
                        try {
                            var s = this
...
, function(t, n, i) {
    ...
    function u(t, n, i) {
        var e;
        return "string" == typeof t ? t : t.type && (e = r[t.type]) ? (t = "string" == typeof e ? c.Tt(e, t) : e(t, n),
    ...
    r.text = function(t) {
        ...
        if (1 === t.version)
            ...
            for (var n = n.replace(i, " onmouseover=\"this.style.color='{hoverColor:string}';this.style.fontWeight='{hoverBold:string}';this.style.fontStyle='{hoverItalic:string}';this.style.textDecoration='{hoverUnderline:string}';\" onmouseout=\"this.style.color='{defaultColor:string}';this.style.fontWeight='{defaultBold:string}';this.style.fontStyle='{defaultItalic:string}';this.style.textDecoration='{defaultUnderline:string}';\""), e = ["default", "hover"], r = 0; r < e.length; r++) {
                var o = e[r]
                  , a = o + "Color"
                  , u = o + "Bold"
                  , s = o + "Italic"
...
, function(t, n) {
    t.exports = {
        ...
        uo: function(t) {
            for (var n = t.response.placement.userdefine || "", i = t.response.placement.encode_userdefine || "", e = (i && "encoded" === i && (n = decodeURIComponent(n),
            t.response.placement.userdefine = n),
            n.split("|") || []), r = {}, o = 0, a = e.length; o < a; o++) {
                var u = e[o].split("=")
                  , s = u[0];
                s && (r[s] = u[1])
            }
            return r.hasOwnProperty("painter") ? r.painter : (i = t.styleOpenApi.tn || "",
            n = parseInt(t.styleOpenApi.xuanting || 0, 10),
            0 <= i.indexOf("mobile") && 0 < n ? "mobile.float" : 0 <= i.indexOf("mobile") ? "mobile.inlayFix" : 0 < n ? "dynamicFloat" : i && 0 < i.length && i.indexOf("_xuanfu") < 0 && i.indexOf("float") < 0 ? "inlayFix" : "")
        },
        so: function(t, n) {
            t = this.co(t);
        ...
        ho: function(t, n) {
            var n = n || t.painter;
            return n ? 2 === n || "mobile.float" === n : (t = (n = t.placement).basic,
            n = n.container,
            1 === t.rspFormat && 2 === t.flowType && (3 === n.anchoredType || 11 === n.anchoredType))
        },
        lo: function(t) {
            var n = t.painter
              , t = t.placement
        ...
        wo: function(t, n) {
            var t = t || n.painter;
            return t ? 4 === t || "mobile.intersitial" === t : (n = (t = n.placement).basic,
            t = t.container,
            1 === n.rspFormat && 2 === n.flowType && 8 === t.anchoredType)
        }
    }
}
, function(t, n, i) {
    ...
    t.exports = {
        ...
        ko: function(t) {
            try {
                for (var n = 0, i = t + "_" + n; o.xn(i) && 0 !== o.xn(i)[0]; ) {
                    var e = o.xn(i);
                    o.Tn(e, a.R),
                    i = t + "_" + ++n
                }
...
, function(t, n, i) {
    ...
    t.exports = {
        ur: function() {
            var t, n, i = window.cpro_id, e = (window.cpro_id = null,
            i && (a = s.In({
                slotId: i,
                productLine: "union",
                isAsync: !1
            ...
            r)
                ...
                n = r.length; t < n; t++) {
                    ...
                    u)
                        o && u[o] && u.hasOwnProperty(o) && (a.styleOpenApi[o] = u[o]);
                    s.Sn(a)
                }
            s.On()
        }
    ...
    t.exports = {
        ...
        On: function() {
            for (var t = 0, n = this.delieveryObjArray.length; t < n; t++) {
                ...
                r instanceof Array && 2 <= r.length && (i = r[0],
                e = r[1],
                r = r[2],
                "fill" !== i && "fillAsync" !== i || !e || ((e = o.In({
                    slotId: e,
                    productLine: "dup",
                    isAsync: "fillAsync" === i
...
, function(t, n, i) {
    ...
    t.exports = {
        ur: function() {
            ...
            c.slotbyds instanceof Array && c.domainInfo.dup && (this.delieveryObjArray = this.delieveryObjArray.concat(c.slotbyds),
            c.slotbyds = []),
            this.Ao(),
        ...
        On: function() {
            for (var t = 0, n = this.delieveryObjArray.length; t < n; t++) {
                var i, e, r, o = this.delieveryObjArray[t];
                !c.domainInfo.dup && o.isAnti ? (c.slotbyds = c.slotbyds || []).push(o) : o.hasOwnProperty("id") ? (i = o.isRelateRecomAd && o.title,
                r = o.hasOwnProperty("isAsync") && o.isAsync || o.hasOwnProperty("async") && o["async"] || i,
                ...
                o.ins && (r.ins = o.ins),
                r.productLine = "adcodexv" === o.productLine || "adcodexr" === o.productLine ? o.productLine : "adcodex",
                a.Sn(r)) : this.So(o)
            }
            this.delieveryObjArray = [],
            a.On()
        ...
        So: function(t) {
            ...
            for (n in r && s.Mt(r) && o.Or.apply(o, r),
            d.dt)
                d.dt.hasOwnProperty(n) && (e = t[i = d.dt[n]],
                s.Nt(e)) && f.we(i, e)
        }
    }
}
, function(t, n, i) {
    ...
    t.exports = {
        ...
        On: function(t) {
            !c.Rn && window.postMessage && (c.Rn = !0,
            u.Zt(window, "message", o.Ht(f, f.Ln))),
            t && f.Dn(t.id, a.N),
            i(17).hr(t)
        }
    }
...
, function(t, n, i) {
    ...
    t.exports = {
        Eo: function(t) {
            try {
                var n, i, e, r, o = s.Wt(t), a = {
                    tuidIndex: t.id || ""
                };
                o ? (n = o.getElementsByTagName("iframe")[0]) ? (e = (i = c.cn(n)).el) ? (r = i.isDisplayHidden ? "display" : "visibility",
                (a = this.Do(e, t, e.tagName)).hiddenProperty = r,
                f.Zn("baiduDomBlockMonitor", a)) : f.Zn("baiduDomShowMonitor", a) : (a = this.Do(n, t, "iframedelete"),
                f.Zn("baiduDomBlockMonitor", a)) : (a = this.Do(o, t, "adcontainerdelete"),
        ...
        Do: function(t, n, i) {
            var e = n.containerId
              ...
              , o = n.paramObj.ps
              , n = "" + n.id;
            return t && (e = t.getAttribute("class"),
            r = t.id),
            {
                slotId: n,
                elementId: r || "",
        ...
        Sr: function(t) {
            var n = window.document.readyState
              , i = this;
            "complete" === n ? this.Oo(t) : s.Zt(window, "load", function() {
                i.Oo(t)
            })
        },
        Oo: function(t) {
...
, function(t, n, i) {
    var r, w = i(0), g = i(2), o = i(5), b = i(1), e = i(6), a = i(10), y = i(4), u = i(3), s = i(14), x = i(8), c = i(21), A = i(46), I = "", k = "", f = "";
    t.exports = {
        ur: function() {
            try {
                var t;
        ...
        Po: function() {
            return !1 !== window.BAIDU_DUP_AUTO_AD && !y.expId && !g.Xt(window) && (y.expId = "110011",
            !0)
        },
        Bo: function(t) {
            ...
            if (t) {
                ...
                if (0 < n.length)
                    for (var i, e = 0; e < n.length; e++)
                        if ((i = decodeURIComponent(n[e])) && 0 <= I.indexOf(i)) {
                            k = i,
                            y.isAutoOpPage = !0;
                            break
                        }
                ...
                if (!((t = a.autoAds).length <= 0)) {
                    ...
                    for (var a = A.Ko(t), t = A.Xo(a), u = t.autoAds, s = t.modelNum, c = this.Go(s, i, u.length, n), f = y.restSlotInfo, d = 0; d < u.length; d++) {
                        ...
                        var h = u[d]
                          ...
                          , m = w.Y !== v && g.vn(v);
                        this.Yo(c[s], l, d, _, !0),
                        this.Wo(l, p, m) ? (p = l + "_" + (h.index || ""),
                        "delete" === _ ? (r--,
                        b.Bt(f) && f[p] && delete y.restSlotInfo[p]) : (h.exps = x.Gi([i, h.exps, s, w.X]),
                        h.autoAddCount = ++e,
                        h.autoAddIndex = r,
                        h.container = m,
                        o.autoAds.push(h))) : ("delete" === _ && r--,
        ...
        $o: function(t, n, i) {
            if (!n)
                return this.Fo(),
                !1;
            for (var e = document.createElement("div"), r = (e.id = "_" + Math.random().toString(36).slice(2),
            -1 < I.indexOf(w.nt) && e.setAttribute("autoaddindex", i.autoAddIndex),
            this.ta(e.id, i, e)), o = 0; o < r.length; o++)
                e.appendChild(r[o]);
            n.insertBefore(e, t)
        },
        ta: function(t, n) {
        ...
        Qo: function(t, n) {
            ...
            var i = n[t]
              , i = (i.result = i.all + "_" + i.success + "_" + (i.all - i.success),
            delete i.all,
            delete i.success,
...
, function(t, n, i) {
    ...
    t.exports = {
        ea: function(t) {
            ...
            return t && 0 <= t.indexOf("|") && (t = t.split("|"),
            n.modelNum = Number(t[0]) || "0",
            t = t[1]) && r.wi(e.J, n.subPattern = t, !0),
            n
        },
        Ko: function(t) {
            for (var n, i = {
                ...
                if ((n = t[r].placement || {}).model)
                    for (var e = ("" + n.model).split(",") || e, o = 0; o < e.length; o++)
                        this.ra(i, e[o], t[r]);
                else
                    this.ra(i, "0", t[r]);
            return i
        ...
        qo: function(t, n) {
            for (var i = {
                ...
                var r, o = ((r = t[e]).placement || {}).subPattern || n, a = i.keys.indexOf(o);
                a < 0 ? (i.keys.push(o),
                i.patternInfoArr[i.keys.length - 1] = [r]) : i.patternInfoArr[a].push(r)
            }
            return i
        },
        Xo: function(t) {
        ...
        oa: function(t) {
            var n, i = t.length, e = t[0];
            return 1 < i && (0 <= (n = t.indexOf("0")) && (t.splice(n, 1),
            i--),
            e = t[o.Qi(i)]),
            e
        },
        Jo: function(t, n) {
            for (var i = {
                subPattern: "",
                autoAds: []
            }, e = t.keys, r = "", o = -1, a = 0; a < e.length; a++)
                0 <= n.indexOf(e[a]) && e[a].length > r.length && (r = e[a],
                o = a);
...
, function(t, n, i) {
    ...
    t.exports = {
        yr: function(t, n, i) {
            var e;
            n && ((e = document.createElement("script")).type = "text/javascript",
            e["async"] = !0,
            e.src = n,
        ...
        ua: function(t, n, i) {
            i = 3 === arguments.length ? (n = arguments[1],
            arguments[2]) : (n = t,
            arguments[1]);
            var e = o[n];
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        render: function(t) {
            ...
            var n = o.Wt(t);
            if (!a.si(t) || !n)
                return a.Dn(t.id, r.R),
                !1;
            var i, e = t.containerInfo.slide, e = e && !d.kt(e) && h;
            e && (f.ro(t),
            this.sa(t)),
            c.mi(t),
            s.renderRichMaterial(t) ? h && setTimeout(function() {
                f.ca("adloaded", t.id)
            }, 800) : (i = a.processSlotInfo(t),
            t.width = i.width,
            t.height = i.height,
            this.fa(n, t),
            i = u.getFrameHTML(t),
...
, function(t, n, i) {
    ...
    t.exports = {
        ao: function(t, n) {
            var t = l.xn(t)
              , t = h.Wt(t);
            t && (t = t.getElementsByTagName("iframe")[0],
            n = JSON.stringify(n),
        ...
        ha: function() {
            var i = this;
            (window.addEventListener || window.attachEvent) && JSON && JSON.parse && e.Zt(window, "message", function(t) {
                if ("string" != typeof t.data)
                    return !1;
                var n = JSON.parse(t.data);
                if (!n.title || "baidudup" !== n.title)
                    return !1;
        ...
        va: function() {
            ...
            for (t in n)
                for (var i in n[t]) {
                    ...
                    if (!i.isExpand)
                        return;
                    var e, r = i.origin, o = r.getElementsByTagName("iframe")[0], a = i.originWidth;
                    switch (t) {
                    case "up":
                    case "down":
        ...
        la: function(t) {
            if (!p[t]) {
                ...
                if (c) {
                    ...
                    if (1 === i || 2 === i ? (f.setAttribute("height", a),
                    f.style.height = a + "px") : 3 !== i && 4 !== i || (f.setAttribute("width", o),
                    f.style.width = o + "px"),
                    2 === s && 2 === i || 2 === s && 4 === i)
                        switch (i) {
                        case 2:
                        ...
                        switch (c.style.position = "relative",
        ...
        ro: function(t) {
            t = l.An(t.slotId);
            t = h.Wt(t);
            t && (t.style.textAlign = "left",
            r || (r = !0,
            this.ha()))
        },
        ca: function(t, n) {
            var i, e, r = l.An(n).containerInfo.slide, r = (r && (i = r.trigger),
            0);
            e = i,
            "[object Array]" === Object.prototype.toString.call(e) ? r = i[0] : i && (r = i);
            ["", "BEFORE_PAGELOAD", "AFTER_PAGECLOSE", "PAGE_PERCENT", "mouseover", "click", "adloaded", "SLIP"][r] === t && this.ao(n, {
                title: "baidudup",
                type: "eventHappen",
                parameters: [t]
            })
    ...
    t.exports = {
        ...
        render: function(t) {
            ...
            if (!u.si(t) || !r)
                return !1;
            s.mi(t),
            f.renderRichMaterial(t) || (i = u.processSlotInfo(t),
            t.width = i.width,
            t.height = i.height,
            2 !== i.sizeType && 5 !== i.sizeType || (e = t.response.pdb_deliv.deliv_des) && e._html && ("text" !== (n = (e = e._html).type) && "image" !== n && "flash" !== n || (e.width = t.width,
            e.height = t.height)),
            this.fa(r, t),
            n = this.xa(t),
            e = c.getFrameHTML(t),
    ...
    t.exports = {
        ...
        Oa: function(t) {
            var n = t.containerInfo
              ...
              , n = (i.sizeType && (i.sizeType = 2),
            n.sizeType = 2,
            s.processSlotInfo(t))
              , r = (n.backgroundOpacity = r,
            n.backgroundColor = e,
            n.borderWidth = o,
            n.btnOpacity = a,
            2 === i.apType ? 2 : 3);
        ...
        Ma: function(t) {
            var n = ""
              ...
              , e = "0"
              , r = 0
              , r = 2 === t.locationType ? (n = "0 0 40px 40px",
            e = t.height,
            i = t.floatingState === this.Aa ? this.Ea : this.Ta,
            this.Ca) : (n = "40px 40px 0 0",
            e = -20,
            i = t.floatingState === this.Aa ? this.Ta : this.Ea,
            this.Sa);
            return {
                domId: t.containerId,
                borderRadius: n,
        ...
        fa: function(t, n) {
            var i = 0
              , e = (n.floatingState !== this.Aa && "ontouchend"in document && 0 < n.height && (i = -1 * (n.height + 20)),
        ...
        Ua: function(t, n, i) {
            ...
            n.style[t] = "0px",
            "top" === t ? (i.style.lineHeight = this.Ca,
            i.innerText = this.Ea) : (i.style.lineHeight = this.Sa,
            i.innerText = this.Ta)
        },
        Ra: function(t, n, i) {
            ...
            n.style["-o-transition"] = t + " 0.75s",
            n.style[t] = -1 * e + "px",
            "top" === t ? (i.style.lineHeight = this.Sa,
            i.innerText = this.Ta) : (i.style.lineHeight = this.Ca,
            i.innerText = this.Ea)
        },
        La: function(t) {
            try {
                var n = 0;
                return 6 == (6 & t.styleOpenApi.apType) || 7 == (7 & t.styleOpenApi.apType) ? n |= 1 : 10 != (10 & t.styleOpenApi.apType) && 11 != (11 & t.styleOpenApi.apType) || (n |= 1,
                t.animation = 1),
                1 == (1 & n) && e.render(t),
                n
            } catch (i) {
                return (new Image).src = "//eclick.baidu.com/se.jpg?" + encodeURIComponent(i.stack) + "&rnd" + Math.random(),
                0
            }
        },
        render: function(t) {
            if (!this.La(t)) {
                ...
                s.Dn(t.id, o.U),
                this.id = t.id;
                var n, i = this.Oa(t), e = (f.mi(t),
                d.renderRichMaterial(t)), r = a.Wt(t);
                !e && r && this.Da(t, i) && (this.fa(r, i),
                e = this.Na(i),
                this.Fa(i, t),
                e = {
                    closeBtnHtml: e,
                ...
                e = this.ya(e),
                r.innerHTML = e,
                (e = r.getElementsByClassName("closeBtn")[0]) && (n = this,
        ...
        Tr: function(t, n, i) {
            ...
            document.body && i && (e = i.getElementsByClassName("closeBtn")[0],
            t = "2" === t ? "top" : "bottom",
            a.Zt(document.body, "touchstart", u.Ht(this, this.Ha)),
            a.Zt(document.body, "touchend", u.Ht(this, this.ja, i, e, t, n)))
        },
        Ha: function(t) {
        ...
        ja: function(t, n, i, e, r) {
            ...
            (t < -10 && !this[e] && r === this.Ia || 10 < t && !this[e] && r === this.ka) && (this[e] = !0,
            this.Ua(e, n, i))
        },
        Pa: function(t, n) {
        ...
        Fa: function(t, n) {
            var i;
            2 === t.sizeType && (t = n.response.pdb_deliv.deliv_des) && t._html && ("text" !== (i = (t = t._html).type) && "image" !== i && "flash" !== i || (t.width = n.width,
            t.height = n.height))
        }
    }
}
, function(t, n, i) {
    ...
    t.exports = {
        ...
        Oa: function(t) {
            var n = t.containerInfo
              , i = t.styleOpenApi
              , n = (n.sizeType = this.za(n.sizeType, i),
            o.processSlotInfo(t));
        ...
        Ja: function(t, n, i) {
            var e = t.firstChild;
            e && "X" === e.textContent && a.Zt(e, "click", function() {
                i.Va(t, n),
        ...
        Ka: function(n, i, e) {
            ...
            i.Xa = function() {
                o = o || setTimeout(function() {
                    var t = s.Li();
                    0 < t - r ? "bottom" === i.locationType && "hide" !== i.status ? (i.status = "hide",
                    e.Va(n, i)) : "top" === i.locationType && "show" !== i.status && (i.status = "show",
                    e.qa(n, i)) : t - r < 0 && ("bottom" === i.locationType && "show" !== i.status ? e.qa(n, i) : "top" === i.locationType && "hide" !== i.status && e.Va(n, i)),
                    r = t,
                    o = null
                }, 200)
            }
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        render: function(t) {
            ...
            f.mi(t);
            var n, i = a.Wt(t);
            i && (s.ae(this.Za, o.Ht(this, this.eu)),
            n = window.cpro_pl_id || window.cpro_pl_classname ? this.ru() : this.ou(i)) && ("complete" === document.readyState ? window.cpro_pl_id || window.cpro_pl_classname ? (this.au(n),
            this.uu(t, i)) : (this.uu(t, i),
            this.au(n)) : a.Zt(document, "readystatechange", o.Ht(this, function() {
                "complete" === document.readyState && (window.cpro_pl_id || window.cpro_pl_classname ? (this.au(n),
                this.uu(t, i)) : (this.uu(t, i),
                this.au(n)))
            })),
            e.Dn(t.id, r.R))
        ...
        au: function(t) {
            for (var n = t.childNodes, i = 0; i < n.length; i++) {
                var e, r = n[i];
                a.rn(r) && (3 === r.nodeType ? (c.ie < 9 && r.nodeValue && (e = r.nodeValue),
                (e = r.textContent ? r.textContent : e) && o.Ot(e) && 0 < e.length && (this.su(r),
                this.Ya = this.Ya + e)) : this.au(r))
            }
        },
        su: function(t) {
            t = t.parentNode;
            t.innerHTML && (this.Ga["item_" + this.Qa] = t,
            this.Qa++)
        },
        eu: function() {
            ...
            if (t) {
                ...
                if (n && 0 !== n.length) {
                    ...
                    for (i in t && (window.cpro_pl_id || window.cpro_pl_classname) && this.cu(t),
                    this.Ga) {
                        var e = this.Ga[i];
                        if (document.contains(e)) {
                            for (var r = e.innerHTML, o = 0; o < n.length; o++)
                                r = this.fu(n[o], r);
                            if (e.innerHTML = r,
                            this.nu === this.$a)
                                break
        ...
        cu: function(t) {
            var n, i = this.ru();
            i && t && ((n = document.createElement("img")).src = t,
...
, function(t, n, i) {
    ...
    t.exports = {
        ...
        pu: function() {
            var t;
            return !!o.baiduboxapp || !(!(t = d.hn(u.bt)) || 18e5 <= (new Date).getTime() - Number(t) && (d.Ci(u.bt),
            1))
        },
        render: function(t) {
            if (!f.si(t) || this.pu())
        ...
        Ja: function(t, n, i) {
            var e, r, o, t = t.getElementsByClassName(i.closeBtnClass), a = t[0];
            a && (e = t[1],
            a.removeAttribute("class"),
            e && e.removeAttribute("class"),
            (r = i.countDown) && e && (o = setInterval(function() {
                e.textContent = --r,
                r || (clearInterval(o),
    ...
    t.exports = {
        ...
        render: function(t) {
            if (this.vu(t)) {
                ...
                !v.si(t))
                    return !1;
                for (var n = t.styleOpenApi, i = t.containerInfo, i = i.location = parseInt(i.location || n.location, 10) || 0, e = this.wu(i, t) || [t], r = 0, o = e.length; r < o; r++) {
                    var a = e[r];
...
, function(t, n, o) {
    ...
    t.exports = {
        gu: function(t) {
            ...
            return t.blockType && "default" !== t.blockType && (n = ["box-sizing: content-box;", "width:{width}px;", "height:{height}px;", "border:#acacac 1px solid;", "overflow:hidden;"],
            "button" === t.blockType && (n.push("position:absolute;left:0;"),
            t.needClose) && n.push("top:" + a.lt + "px;"),
            i = ['<div style="' + n.join("") + '">', "{iframe}", "</div>", "{closeBtn}", "{closeTimeDom}"].join("")),
            i
        },
        bu: function(t, n, i, e) {
        ...
        Cu: function(t) {
            var n = t.containerDom
              , i = (n || ((n = document.createElement("div")).id = t.domId),
            ["box-sizing: content-box;", "width: " + t.containerWidth + "px;", "height: " + t.containerHeight + "px;", "overflow: hidden;", "z-index: 2147483647;"]);
            if (1 === t.followType) {
                if (!r.Ki())
                    return null;
        ...
        Tu: function(t) {
            var n, i, e = t.domId + "_closebtn", e = u.g(e);
            e && (n = e.getElementsByTagName("div")[0],
            i = e.getElementsByTagName("a")[0],
            u.Zt(e, "click", s.Ht(this, this.closeBtnOnClickHandler, t)),
            u.Zt(e, "mouseover", s.Ht(this, this.closeBtnOnMouseOverHandler, t, e, n, i)),
            u.Zt(e, "mouseout", s.Ht(this, this.closeBtnOnMouseOutHandler, t, e, n, i)))
        },
        ...
        closeBtnOnMouseOverHandler: function(t, n, i, e, r) {
            "couplet" === n.blockType ? i.style.backgroundColor = "#0066cc" : "button" === n.blockType && (e.style.backgroundColor = "#0066cc",
            r.style.backgroundImage = "url(https://cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/xuanfu_mouseover_close.png)")
        },
        closeBtnOnMouseOutHandler: function(t, n, i, e, r) {
            "couplet" === n.blockType ? i.style.backgroundColor = "#999999" : "button" === n.blockType && (e.style.backgroundColor = "#999999",
            r.style.backgroundImage = "url(https://cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.1/xuanfu_close.png)")
        },
        ni: function(t) {
        ...
        render: function(t, n) {
            ...
            t.containerDom || (t.containerDom = e,
    ...
    t.exports = {
        mr: function(t) {
            try {
                ...
                a.__timerReportFlag || (setInterval(this.Du, 1500),
                a.__timerReportFlag = !0,
                (window.addEventListener || window.attachEvent) && JSON && JSON.parse && s.Zt(window, "beforeunload", this.Ou))
            } catch (o) {}
        },
        Du: function() {
            try {
                var t, n, i = [], e = a.__iframesStatus;
                for (t in e)
                    2e3 < (new Date).getTime() - e[t].time && !e[t].report && (i.push(t + "_" + e[t].status + "_" + e[t].isAnti + "_" + e[t].proxy),
                    e[t].report = !0);
                0 < i.length && (n = {
                    result: i.join("|")
                },
        ...
        Ou: function() {
            try {
                var t, n, i = [], e = a.__iframesStatus;
                for (t in e)
                    e[t].report || (i.push(t + "_" + e[t].status + "_" + e[t].isAnti + "_" + e[t].proxy),
                    e[t].report = !0);
                0 < i.length && (n = {
                    result: i.join("|")
                },
